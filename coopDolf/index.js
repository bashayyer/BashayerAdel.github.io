...
player1.source = {
    ...
    sources: [
        {
            src: 'https://youtu.be/Ata9cSC2WpM',
            provider: 'youtube',
        },
    ],
};
    ...
    switch (item) {
        case "item1":
            ...
            player1.source = {
                ...
                sources: [
                    {
                        src: 'https://youtu.be/rf60MejMz3E',
                        provider: 'youtube',
                    },
                ],
                autoplay: false,
        ...
        case "item2":
            ...
            player1.source = {
                ...
                sources: [
                    {
                        src: 'https://www.youtube.com/watch?v=OEV8gMkCHXQ',
                        provider: 'youtube',
                    },
                ],
                autoplay: true,
        ...
        case "item3":
            ...
            player1.source = {
                ...
                sources: [
                    {
                        src: 'https://youtu.be/qgRUr-YUk1Q',
                        provider: 'youtube',
                    },
                ],
                autoplay: true,
        ...
        case "item5":
            ...
            player1.source = {
                ...
                sources: [
                    {
                        src: 'https://youtu.be/m3OjWNFREJo',
                        provider: 'youtube',
                    },
                ],
                autoplay: true,
        ...
        case "item7":
            ...
            player1.source = {
                ...
                sources: [
                    {
                        src: 'https://youtu.be/scEDHsr3APg',
                        provider: 'youtube',
                    },
                ],
                autoplay: true,
        ...
        case "item8":
            ...
            player1.source = {
                ...
                sources: [
                    {
                        src: 'https://youtu.be/8lGpZkjnkt4',
                        provider: 'youtube',
                    },
                ],
                autoplay: true,
        ...
        case "item12":
            ...
            player1.source = {
                ...
                sources: [
                    {
                        src: 'https://youtu.be/nhBVL41-_Cw',
                        provider: 'youtube',
                    },
                ],
                autoplay: true,
        ...
        case "item17":
            ...
            player1.source = {
                ...
                sources: [
                    {
                        src: 'https://youtu.be/cWNEl4HE2OE',
                        provider: 'youtube',
                    },
                ],
                autoplay: true,
